...
function createCompleteBackupText() {
  return JSON.stringify({
    ...
    tables: {
      ...
      ai_memory_entries: [{ id: 'memory-1' }],
      ai_memory_evidence_links: [{ id: 'memory-link-1' }],
      intelligence_imports: [{ id: 'import-1' }],
      reviewed_facts: [{ id: 'fact-1' }],
      customer_hypotheses: [{ id: 'hyp-1' }],
      customer_stage_cards: [{ id: 'card-1' }],
